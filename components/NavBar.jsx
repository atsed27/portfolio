...
function NavBar() {
  ...
  return (
    <div
      ...
      className={
        shadow
          ? 'fixed  w-full h-10 md:h-10 lg:h-15 shadow-xl z-[100]'
          : 'fixed  w-full h-10 md:h-15 lg:h-15  z-[100]'
      }
    >
      <div className="flex items-center justify-between w-full h-full px-2 2xl:px-16">
        <Link href={'/'}>
          <h2 className="text-blue-400 text-xl md:text-2xl lg:text-3xl font-mono underline-offset-4 underline ">
            Dani
          </h2>
        </Link>
        <div>
